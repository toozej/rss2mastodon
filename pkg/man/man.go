// Package man provides manual page generation functionality for the rss2mastodon application.
//
// This package creates Unix manual pages (man pages) for the rss2mastodon CLI
...
// Example usage:
//
//	import "github.com/toozej/rss2mastodon/pkg/man"
//
//	// Add man command to root command
//	rootCmd.AddCommand(man.NewManCmd())
//
//	// Generate man pages:
//	// ./rss2mastodon man > rss2mastodon.1
package man
...
// for the rss2mastodon application. The command traverses the root command tree
